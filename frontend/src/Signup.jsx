      ...
      <g id="Layer_3" data-name="Layer 3">
        ...
        ></path>
          ...
          <div className="flex-column">
            ...
            <select className="bg-gray-100 text-gray-900 border-0 rounded-md p-2 mb-2 focus:bg-gray-200 focus:outline-none focus:ring-1 focus:ring-blue-500 transition ease-in-out duration-150"
              id="role"
              name="role"
              value={formData.role}
              onChange={handleChange}
        ...
        <p className="p">
        Already have an account? <span className="span"><Link
